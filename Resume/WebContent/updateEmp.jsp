...
<s:form action="/UpdateEmpData.action" theme="simple" method="post">
	...
	<table class="table table-striped table-bordered table-hover table-condensed">
		<tr>
			<td>员工姓名</td>
			<td>
				<s:textfield name="empName" id="empName" value="%{updateName}"></s:textfield>
			</td>
		</tr>
		<tr>
			<td>员工薪资</td>
			<td>
				<s:textfield name="salary" id="salary" value="%{updateSalary}"></s:textfield>
			</td>
		</tr>
		<tr>
			<td>部门选择</td>
