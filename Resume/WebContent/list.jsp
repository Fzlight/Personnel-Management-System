...
<h3 align="center" >欢迎您管理员：
	<s:property value="#session.adminInfo.adminName"/>
	<s:a href="Checkout">退出</s:a>
</h3></s:if>
<s:else>
...
<s:form method="post" action="/Query.action"> 
	<div class="row alert alert-info" style="margin:0px;padding:5px;">
		<div style="width:250px;">
			<label>员工姓名:</label> 
			<input type="text" name="empName"  class="form-control" placeholder="请输入员工姓名查询"/>
		...
		<s:a href="List">
			<span class="btn btn-success">查询所有</span>
		</s:a>
			...
			<tr>
				...
				<td>
					<!-- 点击修改，提交到action的updateEmp的方法
					 ...
					 -->
					<s:a href="UpdateEmp?empId=%{#emp.empId }">修改</s:a>
				</td>
				<td>
					<s:a href="DeleteEmp?empId=%{#emp.empId }">删除</s:a> 
				</td>
